...
Este arquivo no final está sendo preparado para ser lançado no no git na parte do README.md conforme solicitado no exercício.<br>
## Guia de Instalação<br><br>
...
[x] Controle de Fluxo de Caixa.<br>
[x] Bloco de Notas para Lembretes Gerenciais.<br>
[x] Interface Totalmente Responsiva (Mobile-First).<br>
<br>
<br>
